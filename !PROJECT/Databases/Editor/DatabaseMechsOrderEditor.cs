...
[CustomEditor(typeof(DatabaseMechsOrder))]
public class DatabaseMechsOrderEditor : Editor {
    ...
    public override void OnInspectorGUI() {
        ...
        if (GUILayout.Button("Apply Selection Priorities")) {
            ApplySelectionPriority();
        }
    ...
    private void ApplySelectionPriority() {
        foreach (MechanicalPriority mechPr in db.mechsOrder) {
            mechPr.mech.selectionPriority = mechPr.priority;
        }
        Debug.Log("Mechs Selection Priorities Assigned");
    }
}
